...
class NewsletterDetailView(NewsletterViewBase, DetailView):
    template_name = "newsletter/newsletter/newsletter_detail.html"
    pass
...
class NewsletterListView(NewsletterViewBase, ListView):
    ...
    """
    template_name = "newsletter/newsletter/newsletter_list.html"
...
class ActionUserView(ActionTemplateView):
    ...
    template_name = "newsletter/newsletter/subscription_%(action)s_user.html"
...
class ActionRequestView(ActionFormView):
    ...
    template_name = "newsletter/newsletter/subscription_%(action)s.html"
    ...
    def no_email_confirm(self, form):
        ...
        return redirect(
            self.get_url_from_viewname('newsletter:newsletter_action_activated')
        )

    def get_success_url(self):
        return self.get_url_from_viewname('newsletter:newsletter_activation_email_sent')
...
class UpdateSubscriptionView(ActionFormView):
    ...
    template_name = "newsletter/newsletter/subscription_activate.html"
    ...
    def get_success_url(self):
        return self.get_url_from_viewname('newsletter:newsletter_action_activated')
